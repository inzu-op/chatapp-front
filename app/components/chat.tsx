...
export const ChatWindow: FC<ChatWindowProps> = ({
  ...
  useEffect(() => {
    ...
    socketRef.current = io('https://chatapp-backend-nq57.onrender.com', {
  ...
  useEffect(() => {
    ...
    const fetchInitialMessages = async () => {
      try {
        const res = await fetch(`https://chatapp-backend-nq57.onrender.com/api/messages?userId=${getUserId(selectedUser)}&currentUserId=${currentUserId}`);
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      const res = await fetch(`https://chatapp-backend-nq57.onrender.com/api/users/${currentUserId}`);
  ...
  const fetchChatUsers = async () => {
    try {
      ...
      const res = await fetch(`https://chatapp-backend-nq57.onrender.com/api/users/chat-users?userId=${currentUserId}`);
      const data = await res.json();
  ...
  const handleSend = async () => {
    ...
    try {
      const res = await fetch('https://chatapp-backend-nq57.onrender.com/api/messages', {
        method: 'POST',
  ...
  const handleClearChat = async () => {
    ...
    try {
      const res = await fetch('https://chatapp-backend-nq57.onrender.com/api/messages/clear', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userId: currentUserId,
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      const res = await fetch('https://chatapp-backend-nq57.onrender.com/api/users/remove-chat', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userId: currentUserId,
